...
export class CarsService {
  ...
  constructor() {
    this.cars['J'] = [
      ...
      { make: 'Ford',         baseModel: 'Mustang',       year: 1994 },
      ...
      { make: 'Mitsubishi',   baseModel: 'Lancer',        year: 1995,   model: 'Lancer Evolution VI' },
      { make: 'Mitsubishi',   baseModel: 'Lancer',        year: 2002,   model: 'Lancer Evolution VIII' },
      ...
      { make: 'Renault',      baseModel: 'Clio',          year: 2001,   model: 'Clio RS' },
      ...
      { make: 'Toyota',       baseModel: 'Corolla (EU)',  year: 1995 },
    ...
    this.cars['LAR'] = [
      ...
      { make: 'Subaru',         baseModel: 'Impreza',     year: 2002,   model: 'Impreza WRX STi' }
    ];
    this.cars['MCSR'] = [
      { make: 'BMC',            baseModel: 'Mini',            year: 1959 },
      { make: 'BMW',            baseModel: '5 Series',        year: 1995,   model: 'M5' },
      ...
      { make: 'Renault',        baseModel: '5',               year: 1972 },
      { make: 'Renault',        baseModel: 'Clio',            year: 2001,   model: 'Clio V6' }
    ];
    this.cars['MC2'] = [
      { make: 'Acura',          baseModel: 'Integra',     year: 1995 },
      { make: 'Aston Martin',   baseModel: 'Vanquish',    year: 2001 },
      { make: 'BMW',            baseModel: '5 Series',    year: 1987,   model: 'M5' },
      ...
      { make: 'Nissan',         baseModel: 'Skyline',     year: 1998,   model: 'Skyline GT-R' },
      { make: 'Pontiac',        baseModel: 'GTO',         year: 1964 },
      { make: 'Porsche',        baseModel: '911',         year: 1998,   model: '911 GT3' },
      { make: 'Renault',        baseModel: 'Clio',        year: 1998,   model: 'Clio V6' },
      { make: 'Saleen',         baseModel: 'S7',          year: 2000 },
      { make: 'Toyota',         baseModel: 'MR2',         year: 1989 },
      { make: 'Toyota',         baseModel: 'Supra',       year: 1993,
        note: 'Standard and AB Flug bodykit versions are included' },
      { make: 'Volkswagen',     baseModel: 'Golf',        year: 1997 },
      { make: 'Volkswagen',     baseModel: 'Passat',      year: 1997 }
    ];
    this.cars['MC3'] = [
      ...
      { make: 'Porsche',        baseModel: '911',             year: 1998,   model: 'Gemballa Sport Coupe' },
      { make: 'Saleen',         baseModel: 'S7',              year: 2000 },
    ...
    this.cars['MCLA'] = [
      { make: 'Aston Martin',   baseModel: 'DB9',         year: 2004,   note: 'South Central Vehicle Pack #2' },
      { make: 'Aston Martin',   baseModel: 'Vantage',     year: 2005,   model: 'V8 Vantage Roadster' },
      { make: 'Audi',           baseModel: 'A4',          year: 2004,   model: 'RS4' },
      { make: 'Audi',           baseModel: 'A5',          year: 2007,   model: 'S5',
        note: 'South Central Vehicle Pack #1'  },
      { make: 'Audi',           baseModel: 'R8',          year: 2006,   model: 'R8 4.2 FSI quattro' },
      { make: 'Buick',          baseModel: 'Regal',       year: 1978,   model: 'Regal GNX' },
      { make: 'Buick',          baseModel: 'Riviera',     year: 1963,   note: 'South Central Premium Upgrade' },
      { make: 'Cadillac',       baseModel: 'XLR',         year: 2004,   model: 'XLR-V',
        note: 'South Central Vehicle Pack #2' },
      { make: 'Chevrolet',      baseModel: 'Bel Air',     year: 1955,   note: 'South Central Premium Upgrade' },
      { make: 'Chevrolet',      baseModel: 'Camaro',      year: 1967,   model: 'Camaro SS/RS' },
      ...
      { make: 'Chevrolet',      baseModel: 'Chevelle',    year: 1968,   model: 'Chevelle SS 454',
        note: 'South Central Premium Upgrade'  },
      { make: 'Chevrolet',      baseModel: 'Cobalt',      year: 2005,   model: 'Cobalt SS Supercharged' },
      { make: 'Chevrolet',      baseModel: 'Impala',      year: 1961,   model: 'Impala SS' },
      { make: 'Chevrolet',      baseModel: 'Impala',      year: 1994,   model: 'Impala SS',
        note: 'South Central Premium Upgrade' },
      { make: 'Chevrolet',      baseModel: 'Malibu',      year: 1964,   note: 'South Central Premium Upgrade' },
      ...
      { make: 'Dodge',          baseModel: 'Charger',     year: 2006,   model: 'Charger SRT-8' },
      { make: 'Ford',           baseModel: 'Cobra',       year: 2004,   model: 'Shelby Cobra Concept' }, /* This should be something else */
      ...
      { make: 'Land-Rover',     baseModel: 'Range Rover', year: 2002,
        note: 'Supercharged and Sport Supercharged versions are included in the South Central Premium Upgrade Vehicles pack'},
      { make: 'Mazda',          baseModel: 'RX-7',        year: 1992 },
      ...
      { make: 'Mitsubishi',     baseModel: 'Eclipse',     year: 2006,   model: 'Eclipse Spyder GT',
        note: 'South Central Vehicle Pack #1' },
      { make: 'Mitsubishi',     baseModel: 'Lancer',      year: 2002,   model: 'Lancer MR Evolution IX' },
      { make: 'Mitsubishi',     baseModel: 'Lancer',      year: 2008,   model: 'Lancer MR Evolution X',
        note: 'South Central Vehicle Pack #2' },
      ...
      { make: 'Pontiac',        baseModel: 'GTO',         year: 1964,   note: 'South Central Premium Upgrade' },
      { make: 'Pontiac',        baseModel: 'Solstice',    year: 2006 },
      { make: 'Saleen',         baseModel: 'S302',        year: 2007,   model: 'S302 Extreme' }, /* Should be a Ford model */
    ...
    this.cars['NFSU'] = [
      ...
      { make: 'Honda',      baseModel: 'Civic',     year: 1996,     model: 'Civic Si',  note: 'Coupe' },
      { make: 'Honda',      baseModel: 'S2000',     year: 1999 },
      { make: 'Hyundai',    baseModel: 'Tiburon',   year: 2002,     model: 'Tiburon GT' },
      { make: 'Mazda',      baseModel: 'MX-5',      year: 1998 },
      { make: 'Mazda',      baseModel: 'RX-7',      year: 1992 },
      { make: 'Mitsubishi', baseModel: 'Eclipse',   year: 1995,     model: 'Eclipse GSX' },
      { make: 'Mitsubishi', baseModel: 'Lancer',    year: 2002,     model: 'Lancer ES'},
    ...
    this.cars['NFSMW'] = [
      ...
      { make: 'Dodge',          baseModel: 'Viper',         year: 2003,   model: 'Viper SRT-10' },
      { make: 'Fiat',           baseModel: 'Grande Punto',  year: 2005 },
      { make: 'Ford',           baseModel: 'GT',            year: 2005 },
      { make: 'Ford',           baseModel: 'Mustang',       year: 2005,   model: 'Mustang  GT' },
      { make: 'Lamborghini',    baseModel: 'Gallardo',      year: 2004 },
      { make: 'Lamborghini',    baseModel: 'Murciélago',    year: 2001 },
      ...
      { make: 'Porsche',        baseModel: '911',           year: 1998,
    ...
    this.cars['NFSC'] = [
      ...
      { make: 'Dodge',          baseModel: 'Viper',       year: 2003,   model: 'Viper SRT-10' },
      { make: 'Ford',           baseModel: 'GT',          year: 2005 },
      { make: 'Ford',           baseModel: 'Mustang',     year: 1965,   model: 'Shelby GT500' },
      { make: 'Ford',           baseModel: 'Mustang',     year: 2005,   model: 'Mustang  GT; Shelby GT500 Concept' },
      { make: 'Infiniti',       baseModel: 'G35',         year: 2003 },
      ...
      { make: 'Porsche',        baseModel: 'Cayman',      year: 2005,   model: 'Cayman S' },
      { make: 'Renault',        baseModel: 'Clio',        year: 2001,   model: 'Clio V6' },
      { make: 'Subaru',         baseModel: 'Impreza',     year: 2005,   model: 'Impreza WRX STi' },
      { make: 'Toyota',         baseModel: 'Corolla',     year: 1984,   model: 'Corolla GT-S' },
      { make: 'Toyota',         baseModel: 'MR2',         year: 1989 },
      { make: 'Toyota',         baseModel: 'Supra',       year: 1993 },
      { make: 'Volkswagen',     baseModel: 'Golf',        year: 2003,   model: 'Golf R32' }
    ...
    this.cars['NFS'] = [
      ...
      { make: 'Ford',           baseModel: 'Mustang',     year: 1987,   model: 'Mustang GT' },
      { make: 'Ford',           baseModel: 'Mustang',     year: 2015,   model: 'Mustang GT' },
      { make: 'Honda',          baseModel: 'Civic',       year: 1996,   model: 'Civic Type R',  note: 'Hatchback' },
      ...
      { make: 'Subaru',         baseModel: 'Impreza',     year: 2007,   model: 'Impreza WRX STi', note: 'Hatchback' },
      { make: 'Toyota',         baseModel: 'GT86',        year: 2012 },
      ...
      { make: 'Volkswagen',     baseModel: 'Golf',        year: 1974,   model: 'Golf GTI' },
      { make: 'Volvo',          baseModel: '200 Series',  year: 1974,   model: '242 DL' }
    ];
    this.cars['SRS'] = [
      { make: 'Lexus',      baseModel: 'IS',        year: 1999,     model: 'IS 300',
      ...
      { make: 'Subaru',     baseModel: 'Impreza',   year: 2000,
        note: '2.5 RS, S202 STi, STi, and WRX versions are included.' },
